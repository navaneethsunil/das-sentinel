...
>   - Digest-pinning `FROM` (TR-25) is **done**. SBOM signing/SLSA remains a Hardening-gate item. Container-blocking stays deferred rather than blocking on an upstream base bump. Re-verify at the Hardening gate.
